...
def is_better_hand(hand1, hand2):
	...
	for hand in [cards1, cards2]:
		...
		if len_set == 1 or len_set == 0:
			hand_type = FIVE_OF_A_KIND

		elif len_set == 2:
			if hand.count(list(set_hand)[0]) == 1 or hand.count(list(set_hand)[0]) + hand.count('J') == 4:
			...
			for letter in set_hand:
				if hand.count(letter) + hand.count('J') == 3:
					find_three = True
